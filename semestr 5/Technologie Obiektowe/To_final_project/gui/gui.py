...
from transaction_factory.transaction_factory import TransactionFactory
from observer.observer import BudgetObserver
from matplotlib.figure import Figure
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg
from collections import defaultdict
from .i_gui import IBudgetApp

class BudgetApp(IBudgetApp):
    ...
    def _setup_main_panel(self):
        ...
        canvas = Canvas(transaction_list_frame, bg="#f4f4f9", highlightthickness=0)
        ...
        self.transactions_frame = ttk.Frame(canvas, style="TFrame")
